  ...
  return (
    <>
      <header className="flex items-center justify-between p-4 bg-white fixed top-0 left-0 w-full z-50">
        ...
        >
          <ul className="flex flex-col md:flex-row md:space-x-4 mt-4 md:mt-0 items-center text-center">
            <li>
            ...
            <li className="mt-2 md:mt-0">
              <a
                className="bg-sky-700 text-white px-4 py-2 rounded hover:bg-sky-600 transition-colors duration-300 ease-in-out"
                href="/login"
              >
                Admin
              </a>
